...
internal class AssetsPool
{
    ...
    {
        using var stream = File.Open(EngineContext.Vfs.GetPath(WorldContext.CoreSettings.AssetsPackPath), FileMode.Open,
            FileAccess.Read);
    ...
    {
        using var stream = File.Open(EngineContext.Vfs.GetPath(WorldContext.CoreSettings.AssetsSpacePath),
